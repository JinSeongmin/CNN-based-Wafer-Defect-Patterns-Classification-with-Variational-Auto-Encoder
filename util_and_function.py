...
def data_load(file):
    df = pd.read_pickle("D:/DATASETS/WM811/LSWMD.pkl")
...
def make_data_loader(args, x, y, test_size): 
    ...
    train_loader = data.DataLoader(dataset, batch_size=args.Model_batch_size, drop_last=True)
    test_loader = data.DataLoader(dataset, batch_size=args.Model_batch_size, drop_last=True)
